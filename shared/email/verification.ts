              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td style="padding:28px 32px 12px 32px;">
                    <h1 style="margin:0 0 12px 0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:26px;font-weight:900;line-height:1.2;letter-spacing:0.3px;">Verify your email</h1>
                    <p style="margin:0;color:#a0a0a0;font-size:16px;line-height:1.7;">
                      Hi <strong style="color:#ffffff;">${greetingName}</strong>, thanks for signing up. Please confirm your email address to activate your account and start your fitness journey.
                    </p>
                  </td>
                </tr>
